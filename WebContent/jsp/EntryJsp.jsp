...
<body>
	...
	<form>
		...
		<table align="center">
			...
			<tr>
				<td><img src="http://localhost:8080/ECSite/img/bucket.jpg">
				</td>
			</tr>
		</table>
	</form>
	...
	<div class="top">
		<h2 class="plategreen" id="back">
			<span>新規の方</span>
		</h2>
	<form action="http://localhost:8080/ECSite/jsp/AddUserJsp.jsp"
		method="post">
		<table>
		<tr><td>
